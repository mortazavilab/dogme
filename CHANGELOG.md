...
- Single-cell barcode FASTQs are now filtered from the same accepted reads as the cDNA and UMI FASTQs before `mergeRT`, keeping the published triplet record-synchronous.
